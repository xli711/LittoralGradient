...
function setup() {
  ...
  //DRAW TITLE
  var titleDiv = createDiv('NOT ENOUGH LAND');
  titleDiv.id('title');
  var subTitleDiv = createDiv('A Collection of Land Reclamation Projects in China');
  ...
  L.tileLayer('https://api.mapbox.com/styles/v1/xinhuili/civk4ocmp006s2jrejzye3v9n/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoieGluaHVpbGkiLCJhIjoiY2l2MWFnY3M3MDA2ZzJvczN1MnZjdTV2MCJ9.IVc-aEM5bxHBNMNXb8yfBQ', {
